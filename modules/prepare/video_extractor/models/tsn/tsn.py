...
class TSN(ModelBase):
    ...
    def build_input(self, use_dataloader=True):
        ...
        image_shape[0] = image_shape[0] * self.seglen     # self.seglen=1
        # image_shape = [None, 300, 3 ,target_size, target_size]
        image_shape = [None, self.seg_num] + image_shape  # self.seg_num=300 when infer
